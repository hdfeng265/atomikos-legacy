...
@Configuration
@MapperScan(basePackages={"com.hdfeng.dao.order"},sqlSessionFactoryRef="orderSqlSessionFactory")
public class OrderConfig {
	...
	@Bean
	SqlSessionFactoryBean orderSqlSessionFactory(@Qualifier("orderDataSource")DataSource orderDataSource) {
		...
		sqlSession.setDataSource(orderDataSource);
